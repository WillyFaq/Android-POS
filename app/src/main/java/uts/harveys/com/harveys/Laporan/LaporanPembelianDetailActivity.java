...
public class LaporanPembelianDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laporan_pembelian_detail);
        ...
        tgl_awal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(
                        LaporanPembelianDetailActivity.this,
    ...
    private void get_data(){
        String sql = "SELECT * FROM Pembelian_detail a JOIN Barang b ON a.ID_BARANG = b.ID_BARANG JOIN Pembelian c ON a.ID_PEMBELIAN = c.ID_PEMBELIAN";
        ...
        while (c.moveToNext()){
            ...
            ret[0] = c.getString(c.getColumnIndex("ID_PEMBELIAN_DETAIL"));
            ret[1] = c.getString(c.getColumnIndex("ID_PEMBELIAN"));
