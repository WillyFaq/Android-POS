...
import uts.harveys.com.harveys.Master.BarangEditActivity;
...
public class LaporanPenjualanActivity extends AppCompatActivity {
    ...
    private void get_data(){
        String sql = "SELECT * FROM Penjualan a JOIN Karyawan b ON a.ID_KARYAWAN = b.ID_KARYAWAN";
        ...
        while (c.moveToNext()){
            ...
            ret[0] = c.getString(c.getColumnIndex("ID_PENJUALAN"));
            ret[1] = c.getString(c.getColumnIndex("ID_KARYAWAN"));
            ret[2] = c.getString(c.getColumnIndex("NAMA_CUSTOMER"));
            ret[3] = c.getString(c.getColumnIndex("TANGGAL_PENJUALAN"));
