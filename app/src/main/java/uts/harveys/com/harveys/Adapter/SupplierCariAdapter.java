...
public class SupplierCariAdapter extends BaseAdapter {
    Context context;
    ArrayList<String[]> list;
    LayoutInflater inflter;

    public SupplierCariAdapter(Context applicationContext, ArrayList<String[]> supplier_list){
    ...
    public View getView(int i, View view, ViewGroup parent) {
        if(!list.isEmpty()){
            view = inflter.inflate(R.layout.list_cari_supplier, null);
