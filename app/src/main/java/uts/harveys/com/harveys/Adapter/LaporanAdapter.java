...
public class LaporanAdapter extends BaseAdapter {
    ...
    public LaporanAdapter(Context applicationContext, ArrayList<String[]> laporan_list){
    ...
    public View getView(int i, View view, ViewGroup parent) {
        if(!list.isEmpty()){
            view = inflter.inflate(R.layout.list_laporan, null);
            TextView txt_id_lap = (TextView)view.findViewById(R.id.txt_id_lap);
            TextView txt_tgl_lap = (TextView)view.findViewById(R.id.txt_tgl_lap);
            ...
            txt_id_lap.setText(list.get(i)[0]);
            txt_tgl_lap.setText(list.get(i)[3]);
            txt_desc_lap.setText(list.get(i)[5]+" | "+list.get(i)[2]);
